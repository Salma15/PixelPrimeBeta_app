...
public class APIClass {
    ...
    //public static String DRS_HOST = "http://139.59.99.109/FDCPixel/fdc_api/";
    ...
    public static String DRS_PATIENT_ATTACHMENT_URL = "http://139.59.99.109/FDCPixel/Attach/";    // main server

    // Doctor Profile Pic Download URL
    public static String DRS_DOCTOR_PROFILE_URL = "http://139.59.99.109/FDCPixel/Contributors/docProfilePic/";               // main server
    ...
    public static String DRS_BLOGS_IMAGE_URL = "http://139.59.99.109/FDCPixel/Contributors/Postimages/";
    ...
    public static String DRS_OFFERS_EVENTS_URL = "http://139.59.99.109/FDCPixel/Contributors/Eventimages/";
 ...
 //   public static final String DRS_PRACTICE_MYPATIENT_ADDEPISODE = DRS_HOST + "MY_PATIENT_ADD_EPISODE_PREM";
    ...
    public static final String DRS_PRACTICE_JOB_DESCRIPTION = "http://139.59.99.109/FDCPixel/Partners/download-Attachments.php?";
    ...
    public static String DRS_MYPATIENT_ATTACHMENT_URL_PREM = "http://139.59.99.109/FDCPixel/Partners/episodeAttach/";    // main server
...
//    public static final String KEY_APPT_FILTERTYPE = "appt_filter_type";
    ...
    public static String DRS_MYPATIENT_ATTACHMENT_URL_PRACTICE = "http://139.59.99.109/FDCPixel/Contributors/episodeAttach/";    // main server
    ...
    public static final String DRS_SETTINGS_DOCLOGO_URL = "http://139.59.99.109/FDCPixel/Contributors/docLogo/";
    ...
    public static final String DRS_SHARE_PRESCRIPTION_LINK = "http://139.59.99.109/FDCPixel/Contributors/print-emr/prescs/";
